...
const Accommodation = () => {
  ...
  return (
    <>
      ...
      <section id="accommodation" className="py-20 px-4 bg-gradient-to-b from-orange-50 to-amber-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div className="grid grid-cols-2 gap-4">
              {amenities.map((amenity, index) => (
                ...
                >
                  <div className="amenity-icon text-orange-600 mb-3">
                    {amenity.icon}
                  </div>
          ...
          {/* Room Details Banner */}
          <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-2xl p-3 md:p-4 text-white shadow-xl animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <h3 className="font-serif text-3xl font-bold mb-8 text-center">House Configuration</h3>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="room-stat">
                <div className="text-5xl font-bold mb-2">2</div>
                <div className="text-orange-100 text-lg">Bedrooms</div>
                <div className="text-sm text-orange-200 mt-1">Queen-sized beds</div>
              </div>
              <div className="room-stat">
                <div className="text-5xl font-bold mb-2">4-6</div>
                <div className="text-orange-100 text-lg">Guests</div>
                <div className="text-sm text-orange-200 mt-1">Comfortable capacity</div>
              </div>
              <div className="room-stat">
                <div className="text-5xl font-bold mb-2">1</div>
                <div className="text-orange-100 text-lg">Living Hall</div>
                <div className="text-sm text-orange-200 mt-1">Shared common area</div>
              </div>
            </div>
          </div>
        </div>
